...
draw_roundrect_ext(Tx+5,Ty-60+add_name,Tx+10+string_width(string_hash_to_newline(textbox[? "name"]))+5,Ty-60+add_name+80,global.text_roundingname,global.text_roundingname,false);
draw_set_color(textbox[? "color_nameplate"])
draw_text(Tx+10,Ty-50+add_name2,string_hash_to_newline(textbox[? "name"]));
draw_set_alpha(1);