/// @description text_resize_surfaces()
...
var screen_ratio = __view_get( e__VW.WPort, 0 )/__view_get( e__VW.HPort, 0 );
...
global.text_old_ratio = __view_get( e__VW.WPort, 0 )/__view_get( e__VW.HPort, 0 );