...
draw_roundrect_ext(Tx+30,Ty+Theight-10,Tx+30+string_width(string_hash_to_newline(textbox[? "name"]))+28,+Ty+Theight+102,global.text_roundingname,global.text_roundingname,false);
draw_set_color(textbox[? "color_nameplate"]);
draw_text(Tx+48,Ty+Theight+10,string_hash_to_newline(textbox[? "name"]));
draw_set_alpha(1);